(function () {
                  ...
                  var require$$0$5 = ($_ownKeys && typeof $_ownKeys === 'object' && 'default' in $_ownKeys ? $_ownKeys['default'] : $_ownKeys);
                  ...
                  $export($export.S, 'Reflect', { ownKeys: require$$0$5 });
                  });
                  ...
                  var addInputs = build(regeneratorRuntime.mark(function _callee(elx, ely, container) {
                      var x, y, z, inputEvents;
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                          while (1) {
                              switch (_context.prev = _context.next) {
                                  case 0:
                                      x = map(Number, inputValue(elx));
                                      y = map(Number, inputValue(ely));
                                      z = liftA2(add, x, y);
                                      _context.next = 5;
                                      return domEvent('input', container);

                                  case 5:
                                      inputEvents = _context.sent;
                                      return _context.abrupt('return', sample(z, inputEvents));
