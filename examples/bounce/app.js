(function () {
                  ...
                  var require$$1$1 = ($_task && typeof $_task === 'object' && 'default' in $_task ? $_task['default'] : $_task);
                  ...
                  var require$$0$1 = ($_partial && typeof $_partial === 'object' && 'default' in $_partial ? $_partial['default'] : $_partial);
                  ...
                  var newSignal = function newSignal(f) {
                      return new Signal(f);
                  };
                  ...
                  var step = function step(x, e) {
                      return switcher(constant(x), mapE(constant, e));
                  };
                  ...
                  var schedule = (function (cancel, schedule) {
                  ...
                  var inputValue = function inputValue(input) {
                      return map(getValue, constant(input));
                  };
                  ...
                  var animationFrames = function animationFrames() {
                      return schedule(cancelAnimationFrame, requestAnimationFrame);
                  };
                  ...
                  var integralWith = function integralWith(f, w, a, s) {
                      return newSignal(function (t) {
                          return signalStep(a, runIntegralWith(f, w, a, s, t));
                      });
                  };

                  var runIntegralWith = function runIntegralWith(f, w, a0, s, t0) {
                      return newSignal(function (t) {
                          return stepWith(f, w.runSignal(t), a0, s.runSignal(t), t, t0);
                      });
                  };
                  ...
                  var dots = build(regeneratorRuntime.mark(function _callee() {
                      var initBounds, dots, position, speed, resizeWindow, bounds, velocity, state, pos, world, rate;
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                          while (1) {
                              switch (_context.prev = _context.next) {
                                  case 0:
                                      initBounds = getBounds();
                                      dots = createDots(document.body, 200);
                                      position = dots.map(randomDotState);
                                      speed = inputValue(document.getElementById('speed'));
                                      _context.next = 6;
                                      return resize(window);

                                  case 6:
                                      resizeWindow = _context.sent;
                                      bounds = map(getBounds, step(initBounds, resizeWindow));
                                      velocity = constant(dots.map(randomVelocity));
                                      state = liftA2(function (speed, bounds) {
                                          return { speed: speed, bounds: bounds };
                                      }, speed, bounds);
                                      pos = integralWith(moveDots, state, position, velocity);
                                      world = liftA2(function (dots, pos) {
                                  ...
                                  case 14:
                                      rate = _context.sent;
                                      return _context.abrupt('return', sample(world, rate));
