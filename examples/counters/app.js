(function () {
                  ...
                  var is = __commonjs(function (module) {
                  module.exports = {
                    array: Array.isArray,
                  ...
                  var require$$0 = (is && typeof is === 'object' && 'default' in is ? is['default'] : is);

                  var vnode$1 = __commonjs(function (module) {
                  ...
                  var require$$1 = (vnode$1 && typeof vnode$1 === 'object' && 'default' in vnode$1 ? vnode$1['default'] : vnode$1);
                  ...
                  var hh = (index$2 && typeof index$2 === 'object' && 'default' in index$2 ? index$2['default'] : index$2);

                  var _class = __commonjs(function (module) {
                  ...
                  var cls = (_class && typeof _class === 'object' && 'default' in _class ? _class['default'] : _class);

                  var snabbdom = __commonjs(function (module) {
                  // jshint newcap: false
                  ...
                  var snabbdom$1 = (snabbdom && typeof snabbdom === 'object' && 'default' in snabbdom ? snabbdom['default'] : snabbdom);
                  ...
                  var scan = function scan(f, a, e) {
                      return new Event(function (t) {
                          return at(t, eventStep(a, runAccum(f, a, e)));
                      });
                  };

                  // accum :: a -> Event t (a -> a) -> Event t a
                  // Accumulate events starting with initial value and a update-function event
                  var accumE = function accum(a, e) {
                      return scan(function (a, f) {
                          return f(a);
                      }, a, e);
                  };

                  var runAccum = function runAccum(f, a, e) {
                      return new Event(function (t) {
                          return e.runEvent(t).map(function (_ref7) {
                              var value = _ref7.value;
                              var next = _ref7.next;
                              return accumNext(f, f(a, value), next);
                          });
                      });
                  };

                  var accumNext = function accumNext(f, b, next) {
                      return eventStep(b, runAccum(f, b, next));
                  };
                  ...
                  var require$$1$1 = ($_core && typeof $_core === 'object' && 'default' in $_core ? $_core['default'] : $_core);
                  ...
                  var require$$0$2 = ($_global && typeof $_global === 'object' && 'default' in $_global ? $_global['default'] : $_global);
                  ...
                  var store = require$$2$6('wks'),
                      uid = require$$4$4,
                      _Symbol = require$$0$2.Symbol;
                  module.exports = function (name) {
                    return store[name] || (store[name] = _Symbol && _Symbol[name] || (_Symbol || uid)('Symbol.' + name));
                  };
                  });

                  var require$$0$1 = ($_wks && typeof $_wks === 'object' && 'default' in $_wks ? $_wks['default'] : $_wks);
                  ...
                  var require$$0$12 = ($_fails && typeof $_fails === 'object' && 'default' in $_fails ? $_fails['default'] : $_fails);

                  var $_descriptors = __commonjs(function (module) {
                  // Thank's IE8 for his funny defineProperty
                  module.exports = !require$$0$12(function () {
                  ...
                  var require$$1$12 = ($_descriptors && typeof $_descriptors === 'object' && 'default' in $_descriptors ? $_descriptors['default'] : $_descriptors);
                  ...
                  var require$$1$5 = ($ && typeof $ === 'object' && 'default' in $ ? $['default'] : $);

                  var $_hide = __commonjs(function (module) {
                  var $ = require$$1$5,
                      createDesc = require$$3;
                  module.exports = require$$1$12 ? function (object, key, value) {
                  ...
                  var def = require$$1$5.setDesc,
                      has = require$$5,
                      TAG = require$$0$1('toStringTag');
                  ...
                  require$$6(IteratorPrototype, require$$0$1('iterator'), function () {
                    return this;
                  });
                  ...
                  var require$$0$27 = ($_defined && typeof $_defined === 'object' && 'default' in $_defined ? $_defined['default'] : $_defined);
                  ...
                  var require$$1$20 = ($_iobject && typeof $_iobject === 'object' && 'default' in $_iobject ? $_iobject['default'] : $_iobject);

                  var $_toIobject = __commonjs(function (module) {
                  // to indexed object, toObject with fallback for non-array-like ES3 strings
                  var IObject = require$$1$20,
                  ...
                  var require$$0$6 = ($_toIobject && typeof $_toIobject === 'object' && 'default' in $_toIobject ? $_toIobject['default'] : $_toIobject);
                  ...
                  module.exports = require$$0$2.document && document.documentElement;
                  });
                  ...
                  var require$$1$4 = ($_invoke && typeof $_invoke === 'object' && 'default' in $_invoke ? $_invoke['default'] : $_invoke);
                  ...
                  if (!setTask || !clearTask) {
                    ...
                    // Node.js 0.8-
                    if (require$$0$23(process) == 'process') {
                  ...
                  var require$$0$3 = ($_partial && typeof $_partial === 'object' && 'default' in $_partial ? $_partial['default'] : $_partial);
                  ...
                  var require$$0$26 = ($_toInteger && typeof $_toInteger === 'object' && 'default' in $_toInteger ? $_toInteger['default'] : $_toInteger);

                  var $_toLength = __commonjs(function (module) {
                  // 7.1.15 ToLength
                  var toInteger = require$$0$26,
                      min = Math.min;
                  module.exports = function (it) {
                  ...
                  var require$$0$17 = ($_toLength && typeof $_toLength === 'object' && 'default' in $_toLength ? $_toLength['default'] : $_toLength);
                  ...
                  var require$$0$11 = ($_anObject && typeof $_anObject === 'object' && 'default' in $_anObject ? $_anObject['default'] : $_anObject);
                  ...
                  var require$$0$4 = ($_collectionToJson && typeof $_collectionToJson === 'object' && 'default' in $_collectionToJson ? $_collectionToJson['default'] : $_collectionToJson);

                  var es7_set_toJson = __commonjs(function (module) {
                  // https://github.com/DavidBruant/Map-Set.prototype.toJSON
                  var $export = require$$2;

                  $export($export.P, 'Set', { toJSON: require$$0$4('Set') });
                  });
                  ...
                  $export($export.P, 'Map', { toJSON: require$$0$4('Map') });
                  });
                  ...
                  var require$$0$5 = ($_objectToArray && typeof $_objectToArray === 'object' && 'default' in $_objectToArray ? $_objectToArray['default'] : $_objectToArray);

                  var es7_object_entries = __commonjs(function (module) {
                  // http://goo.gl/XkBrjD
                  var $export = require$$2,
                      $entries = require$$0$5(true);
                  ...
                  var require$$0$7 = ($_ownKeys && typeof $_ownKeys === 'object' && 'default' in $_ownKeys ? $_ownKeys['default'] : $_ownKeys);
                  ...
                  var require$$0$8 = ($_replacer && typeof $_replacer === 'object' && 'default' in $_replacer ? $_replacer['default'] : $_replacer);
                  ...
                  var require$$0$9 = ($_stringPad && typeof $_stringPad === 'object' && 'default' in $_stringPad ? $_stringPad['default'] : $_stringPad);
                  ...
                  var require$$1$6 = ($_stringAt && typeof $_stringAt === 'object' && 'default' in $_stringAt ? $_stringAt['default'] : $_stringAt);
                  ...
                  var require$$1$18 = ($_toIndex && typeof $_toIndex === 'object' && 'default' in $_toIndex ? $_toIndex['default'] : $_toIndex);

                  var $_arrayIncludes = __commonjs(function (module) {
                  // false -> Array#indexOf
                  // true  -> Array#includes
                  var toIObject = require$$0$6,
                      toLength = require$$0$17,
                      toIndex = require$$1$18;
                  ...
                  var getDesc = require$$1$5.getDesc,
                  ...
                  $export($export.S, 'Reflect', { ownKeys: require$$0$7 });
                  });
                  ...
                  $export($export.S + $export.F * require$$0$12(function () {
                  ...
                  var $ = require$$1$5,
                      ...
                      anObject = require$$0$11,
                      isObject = require$$2$2,
                      bind = Function.bind || require$$1$1.Function.prototype.bind;
                  ...
                  var require$$1$10 = ($_iterDetect && typeof $_iterDetect === 'object' && 'default' in $_iterDetect ? $_iterDetect['default'] : $_iterDetect);
                  ...
                  var require$$0$13 = ($_collection && typeof $_collection === 'object' && 'default' in $_collection ? $_collection['default'] : $_collection);
                  ...
                  var require$$1$19 = ($_isArray && typeof $_isArray === 'object' && 'default' in $_isArray ? $_isArray['default'] : $_isArray);

                  var $_arraySpeciesCreate = __commonjs(function (module) {
                  // 9.4.2.3 ArraySpeciesCreate(originalArray, length)
                  var isObject = require$$2$2,
                      isArray = require$$1$19,
                      SPECIES = require$$0$1('species');
                  ...
                  var require$$0$28 = ($_arraySpeciesCreate && typeof $_arraySpeciesCreate === 'object' && 'default' in $_arraySpeciesCreate ? $_arraySpeciesCreate['default'] : $_arraySpeciesCreate);

                  var $_toObject = __commonjs(function (module) {
                  // 7.1.13 ToObject(argument)
                  var defined = require$$0$27;
                  module.exports = function (it) {
                  ...
                  require$$0$13('WeakSet', function (get) {
                  ...
                  var $WeakMap = require$$0$13('WeakMap', function (get) {
                  ...
                  var require$$1$11 = ($_setSpecies && typeof $_setSpecies === 'object' && 'default' in $_setSpecies ? $_setSpecies['default'] : $_setSpecies);
                  ...
                  var require$$1$9 = ($_collectionStrong && typeof $_collectionStrong === 'object' && 'default' in $_collectionStrong ? $_collectionStrong['default'] : $_collectionStrong);

                  var es6_set = __commonjs(function (module) {
                  'use strict';

                  var strong = require$$1$9;

                  // 23.2 Set Objects
                  require$$0$13('Set', function (get) {
                    return function Set() {
                      return get(this, arguments.length > 0 ? arguments[0] : undefined);
                    };
                  }, {
                  ...
                  var global = require$$0$2,
                      ...
                      isNode = require$$0$23(process) == 'process',
                      head,
                      last,
                      notify;
                  ...
                  var require$$0$14 = ($_sameValue && typeof $_sameValue === 'object' && 'default' in $_sameValue ? $_sameValue['default'] : $_sameValue);
                  ...
                  $export($export.S + $export.F * !(USE_NATIVE && require$$1$10(function (iter) {
                  ...
                  var require$$0$15 = ($_fixReWks && typeof $_fixReWks === 'object' && 'default' in $_fixReWks ? $_fixReWks['default'] : $_fixReWks);

                  var es6_regexp_split = __commonjs(function (module) {
                  // @@split logic
                  require$$0$15('split', 2, function (defined, SPLIT, $split) {
                  ...
                  // @@search logic
                  require$$0$15('search', 1, function (defined, SEARCH) {
                  ...
                  // @@replace logic
                  require$$0$15('replace', 2, function (defined, REPLACE, $replace) {
                  ...
                  // @@match logic
                  require$$0$15('match', 1, function (defined, MATCH) {
                  ...
                  // 21.2.5.3 get RegExp.prototype.flags()
                  var $ = require$$1$5;
                  if (require$$1$12 && /./g.flags != 'g') $.setDesc(RegExp.prototype, 'flags', {
                    configurable: true,
                    get: require$$5$1
                  });
                  });
                  ...
                  var require$$1$13 = ($_isRegexp && typeof $_isRegexp === 'object' && 'default' in $_isRegexp ? $_isRegexp['default'] : $_isRegexp);

                  var es6_regexp_constructor = __commonjs(function (module, exports, global) {
                  var $ = require$$1$5,
                      global = require$$0$2,
                      isRegExp = require$$1$13,
                      $flags = require$$5$1,
                  ...
                  if (require$$1$12 && (!CORRECT_NEW || require$$0$12(function () {
                  ...
                  var require$$1$14 = ($_arrayFill && typeof $_arrayFill === 'object' && 'default' in $_arrayFill ? $_arrayFill['default'] : $_arrayFill);

                  var es6_array_fill = __commonjs(function (module) {
                  // 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
                  var $export = require$$2;

                  $export($export.P, 'Array', { fill: require$$1$14 });
                  ...
                  var require$$1$15 = ($_arrayCopyWithin && typeof $_arrayCopyWithin === 'object' && 'default' in $_arrayCopyWithin ? $_arrayCopyWithin['default'] : $_arrayCopyWithin);

                  var es6_array_copyWithin = __commonjs(function (module) {
                  // 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
                  var $export = require$$2;

                  $export($export.P, 'Array', { copyWithin: require$$1$15 });
                  ...
                  var ctx = require$$4,
                      ...
                      toLength = require$$0$17,
                      getIterFn = require$$0$16;
                  $export($export.S + $export.F * !require$$1$10(function (iter) {
                    Array.from(iter);
                  }), 'Array', {
                  ...
                  var require$$0$18 = ($_failsIsRegexp && typeof $_failsIsRegexp === 'object' && 'default' in $_failsIsRegexp ? $_failsIsRegexp['default'] : $_failsIsRegexp);

                  var $_stringContext = __commonjs(function (module) {
                  // helper for String#{startsWith, endsWith, includes}
                  var isRegExp = require$$1$13,
                      defined = require$$0$27;
                  ...
                  $export($export.P + $export.F * require$$0$18(STARTS_WITH), 'String', {
                  ...
                  $export($export.P + $export.F * require$$0$18(ENDS_WITH), 'String', {
                  ...
                  var require$$0$19 = ($_mathExpm1 && typeof $_mathExpm1 === 'object' && 'default' in $_mathExpm1 ? $_mathExpm1['default'] : $_mathExpm1);
                  ...
                  var require$$0$20 = ($_mathSign && typeof $_mathSign === 'object' && 'default' in $_mathSign ? $_mathSign['default'] : $_mathSign);

                  var es6_math_sign = __commonjs(function (module) {
                  // 20.2.2.28 Math.sign(x)
                  var $export = require$$2;

                  $export($export.S, 'Math', { sign: require$$0$20 });
                  });
                  ...
                  var require$$0$21 = ($_mathLog1p && typeof $_mathLog1p === 'object' && 'default' in $_mathLog1p ? $_mathLog1p['default'] : $_mathLog1p);

                  var es6_math_log1p = __commonjs(function (module) {
                  // 20.2.2.20 Math.log1p(x)
                  var $export = require$$2;

                  $export($export.S, 'Math', { log1p: require$$0$21 });
                  });
                  ...
                  $export($export.S, 'Math', { expm1: require$$0$19 });
                  });
                  ...
                  var require$$0$22 = ($_isInteger && typeof $_isInteger === 'object' && 'default' in $_isInteger ? $_isInteger['default'] : $_isInteger);

                  var es6_number_isSafeInteger = __commonjs(function (module) {
                  // 20.1.2.5 Number.isSafeInteger(number)
                  var $export = require$$2,
                      isInteger = require$$0$22,
                      abs = Math.abs;
                  ...
                  $export($export.S, 'Number', { isInteger: require$$0$22 });
                  });

                  var es6_number_isFinite = __commonjs(function (module) {
                  // 20.1.2.2 Number.isFinite(number)
                  var $export = require$$2,
                      _isFinite = require$$0$2.isFinite;
                  ...
                  if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
                    ...
                    $.each.call(require$$1$12 ? $.getNames(Base) : (
                    // ES3:
                  ...
                  var $ = require$$1$5,
                      isObject = require$$2$2,
                      HAS_INSTANCE = require$$0$1('hasInstance'),
                  ...
                  var setDesc = require$$1$5.setDesc,
                      createDesc = require$$3,
                      has = require$$5,
                      ...
                      NAME = 'name';
                  // 19.2.4.2 name
                  NAME in FProto || require$$1$12 && setDesc(FProto, NAME, {
                    configurable: true,
                    get: function get() {
                  ...
                  require$$0$24('getOwnPropertyNames', function () {
                  ...
                  require$$0$24('keys', function ($keys) {
                  ...
                  require$$0$24('getPrototypeOf', function ($getPrototypeOf) {
                  ...
                  require$$0$24('getOwnPropertyDescriptor', function ($getOwnPropertyDescriptor) {
                  ...
                  require$$0$24('isExtensible', function ($isExtensible) {
                  ...
                  require$$0$24('isSealed', function ($isSealed) {
                  ...
                  require$$0$24('isFrozen', function ($isFrozen) {
                  ...
                  require$$0$24('preventExtensions', function ($preventExtensions) {
                  ...
                  require$$0$24('seal', function ($seal) {
                  ...
                  require$$0$24('freeze', function ($freeze) {
                  ...
                  var classof = require$$3$3,
                      test = {};
                  test[require$$0$1('toStringTag')] = 'z';
                  if (test + '' != '[object z]') {
                  ...
                  var $export = require$$2;
                  $export($export.S, 'Object', { is: require$$0$14 });
                  });
                  ...
                  var require$$0$25 = ($_objectAssign && typeof $_objectAssign === 'object' && 'default' in $_objectAssign ? $_objectAssign['default'] : $_objectAssign);

                  var es6_object_assign = __commonjs(function (module) {
                  // 19.1.3.1 Object.assign(target, source)
                  var $export = require$$2;

                  $export($export.S + $export.F, 'Object', { assign: require$$0$25 });
                  });
                  ...
                  $export($export.S, 'Array', { isArray: require$$1$19 });
                  ...
                  // -------------------------------------------------------
                  // Rendering
                  var patch = snabbdom$1.init([cls]);

                  var render = function render(_ref) {
                      var counters = _ref.counters;
                      var current = _ref.current;
                      return div('#container', [button('#add-counter', 'Add counter'), button('#remove-counter', 'Remove counter'), p(renderCounters(current, counters)), button('#left', '<<'), button('#inc', '+'), button('#dec', '-'), button('#right', '>>')]);
                  };

                  var renderCounters = function renderCounters(current, counters) {
                      return counters.map(function (val, i) {
                          return span('.counter', { class: { current: i === current } }, '' + val);
                      });
                  };

                  // -------------------------------------------------------
                  // App state
                  var data = localStorage.getItem('counters');
                  var initialState = data ? JSON.parse(data) : { counters: [0, 0], current: 0 };

                  // -------------------------------------------------------
                  // Actions are represented as functions that update
                  // the appliction state.
                  // type Action s :: s -> s
                  var switchCounter = function switchCounter(x) {
                      return function (_ref2) {
                          var counters = _ref2.counters;
                          var current = _ref2.current;
                          return { counters: counters, current: inbounds(counters.length, current + x) };
                      };
                  };
                  var inbounds = function inbounds(bound, n) {
                      return n < 0 ? bound + n : n % bound;
                  };

                  var addCurrent = function addCurrent(x) {
                      return function (_ref3) {
                          var counters = _ref3.counters;
                          var current = _ref3.current;
                          return { counters: update(counters[current] + x, current, counters), current: current };
                      };
                  };
                  ...
                  var remove = function remove(_ref5) {
                      var counters = _ref5.counters;
                      var current = _ref5.current;
                      return { counters: counters.slice(0, counters.length - 1), current: Math.min(current, counters.length - 2) };
                  };

                  var update = function update(newVal, at, a) {
                      var b = a.slice();
                      b[at] = newVal;
                      return b;
                  };
                  ...
                  var vnode = patch(byId('container'), render(initialState));
                  var updateView = function updateView(newVTree) {
                      return vnode = patch(vnode, newVTree);
                  };

                  // -------------------------------------------------------
                  // Build event network
                  var counters = build(regeneratorRuntime.mark(function _callee() {
                      var addCounter, removeCounter, nextCounter, prevCounter, incCounter, decCounter, actions;
                          ...
                          while (1) {
                              switch (_context.prev = _context.next) {
                                  ...
                                  case 28:
                                      ...
                                      decCounter = mapto(_context.t10, _context.t11);
                                      actions = [addCounter, removeCounter, nextCounter, prevCounter, incCounter, decCounter].reduce(merge);
                                      return _context.abrupt('return', accumE(initialState, actions));
